...
abstract class $WeatherStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Weather? weather, Status status, String message});
...
class _$_WeatherState implements _WeatherState {
  const _$_WeatherState(
      {this.weather = null, this.status = Status.initial, this.message = ''});
  ...
  @override
  String toString() {
    return 'WeatherState(weather: $weather, status: $status, message: $message)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, weather, status, message);
